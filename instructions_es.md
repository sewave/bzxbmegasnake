...
Gracias especiales a [DamienG](https://damieng.com/typography/zx-origins/) por las increíbles fuentes. (Uso la fuente [Koncrete](https://damieng.com/typography/zx-origins/koncrete/))

## El juego

El objetivo del juego es comerte todas las frutas de cada uno de los 16 niveles.

Cada cuatro niveles tendrás un nivel de bonificación para conseguir más puntos. Puedes seguir jugando mientras quede tiempo y no mueras.
